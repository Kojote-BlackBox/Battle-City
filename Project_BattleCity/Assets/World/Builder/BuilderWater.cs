...
namespace World.Builder {
    public class BuilderWater {
        ...
        private BuilderMap mapBuilderScript;
        private Map mapScript;

        public BuilderWater(BuilderMap builderMap) {
            this.mapBuilderScript = builderMap;
            this.mapScript = mapBuilderScript.map;
        }
        ...
        public void Generate(TileData tileData, float coverage, float coherence) {
            ...
            int toCover = (int)(mapScript.columns * mapScript.rows * coverage);
            int covered = 0;
